...
import { CurrencyDollarIcon, EyeIcon, HeartIcon, IdentificationIcon, TagIcon } from '@heroicons/react/24/solid'
...
const NFTDetail = () => {
  ...
  const props = (nftWithPrice.nft.metadata.properties || []) as { name: string, value: string }[]
    ...
    <>
      <div className='flex gap-16'>
        ...
        <div>
          ...
          <div className='mt-6'>
            ...
            <div>
              {nftWithPrice.nft.metadata.description}
            </div>
          </div>
      ...
      <div className='mt-5 rounded-md '>
        ...
        {myEvents?.map((item, index) => (
          <div key={index} className="mt-1 flex justify-between border p-2 text-xs">
            <span className='flex'>
            ...
            <span className='flex'>
              ...
              lister: <br />{item.data?.lister.toString()}
            </span>
            <span className='flex'>
              <IdentificationIcon className='mr-1 w-4' />
              buyer: <br />{item.data?.buyer.toString()}
            </span>
          </div>
        ))}
      </div>
