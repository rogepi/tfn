  ...
  return (
    <div>
      ...
      <div className="my-8 flex  gap-5">
        {listing.map(item =>
          <Link href={`/nft/${item.id}`} className="flex h-60 w-44 flex-col items-center justify-center gap-3 overflow-hidden rounded-md border shadow-md hover:border-gray-300" key={item.id}>
